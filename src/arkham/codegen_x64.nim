...
proc marshalAggrFromAddr(g: var CodeGen; addrReg: Reg; typeSym: SymId; regs: openArray[Reg])
  ...
  of RetS:
    ...
    cc.into:
      ...
      if g.isEntryProc and not g.prog.windows:
        ...
        # A TAIL CALL has left the proc for good: no jump to the epilogue either,
